        ...
        <div class="m-auto pt-20">
            ...
            <x-blog.components.card title="Edit Post" subtitle="Use the form below to edit post..">
                <form
                    ...
                    <div class="mt-4">
                        <textarea placeholder="Enter Excerpt" :value="old('excerpt', $postValue->excerpt ?? '')" name="excerpt" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="6" cols="80" type="text"></textarea>
