<x-app-layout>
    ...
    <div class="w-4/5 mx-auto pb-32">
        ...
        <div class="m-auto pt-20">
            ...
            <x-blog.components.card title="Create Prompt" subtitle="Use the form below to a prompt to a post to be generated..">
            <form
                action="{{ route('blog.ai-prompt.save') }}"
                method="POST"
                ...
                <textarea placeholder="Enter Prompt" :value="old('prompt')" name="prompt" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="6" cols="80" type="text"></textarea>
