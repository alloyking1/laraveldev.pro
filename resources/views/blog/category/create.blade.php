    ...
    <div class="w-4/5 mx-auto pb-32">
        ...
        <div class="m-auto pt-20">
            ...
            <form action="{{ route('category.save') }}" method="POST">
                @csrf
                <div class="mt-4">
                    <x-text-input id="title" placeholder="title" class="block mt-1 w-full" type="text" name="title" :value="old('category')" required autofocus autocomplete="category" />
                    <x-input-error :messages="$errors->get('category')" class="mt-2" />
                </div>
                <div class="mt-4">
                    <textarea placeholder="Enter Excerpt" :value="old('description')" name="description" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="6" cols="80" type="text"></textarea>
